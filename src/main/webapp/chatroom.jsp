...
<input type="submit" id="quit" value="Quit!" onclick="sendQuit();"/><br>
...
<script type="text/javascript">
    ...
    function connect() {
        ...
        wsocket = new WebSocket("ws://localhost:8080/yab/websocket");
...
<div id="chatroom">
    ...
    <button onclick="send()">send msg</button><br>
    <textarea id="textarea" cols="70" rows="20" readonly="true"></textarea><br>
    <button onclick="closeWebSocket()">close socket</button><br>
</div>
-->
...
<script>
    ...
    if('WebSocket' in window){
        webSocket = new WebSocket("ws://localhost:8080/yab/websocket");
    }
    else{
        alert("No websocket!");
    }
    ...
    webSocket.onerror = function() {
        setContent("websocket error");
    };

    webSocket.onopen = function(){
        setContent("websocket open");
    };
