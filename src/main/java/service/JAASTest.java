...
public class JAASTest
{
   ...
   {
      System.setProperty("java.security.policy", "src/main/java/PermissionTest.policy");
      System.setProperty("java.security.auth.login.config","src/main/java/jaas.config");
